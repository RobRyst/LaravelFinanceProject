...
const submit = () => {
    console.log('Form data:', form.data); // Debug the form data
    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div>
                ...
                <TextInput id="lastname" type="text" class="mt-1 block w-full" v-model="form.lastname" required autofocus autocomplete="last name" />
