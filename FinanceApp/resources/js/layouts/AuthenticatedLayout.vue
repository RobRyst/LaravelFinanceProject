...
<template>
    ...
    <div>
        <div class="flex min-h-screen bg-gray-100">
            <nav class="w-64 border-r border-gray-100 bg-zinc-800">
                    ...
                    <div class="flex h-16 flex-col">
                        <div class="space-y-6 px-4 py-6">
                            ...
                            <div class="flex hidden flex-col gap-4 sm:-my-px sm:ms-5 sm:flex">
                                ...
                                <NavLink :href="route('transactionPage')" class="text-xl text-white" :active="route().current('transactionPage')"
            ...
            <div class="flex flex-1 flex-col">
                <div class="flex">
                    <header class="w-full bg-white shadow" v-if="$slots.header">
